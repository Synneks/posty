...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPosts', hasMore: boolean, posts: Array<{ __typename?: 'Post', id: number, title: string, points: string, creatorId: number, createdAt: string, textSnippet: string, creator: { __typename?: 'User', id: number, username: string } }> } };

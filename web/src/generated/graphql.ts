...
export type PostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', id: number, title: string, textSnippet: string, points: string, creatorId: number, createdAt: string, updatedAt: string }> };
